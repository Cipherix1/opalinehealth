...
const teamMembers = [
  {
    ...
    image: "https://crescentahealthcare.com/wp-content/uploads/2026/01/pexels-olly-3771097-edited-scaled.jpg",
    bio: "As CEO of Opalin Healthcare System, I lead our RCM strategy, focusing on accuracy, compliance, and driving consistent revenue growth for our healthcare partners.",
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20">
          ...
          >
            ...
            <p className="text-xl text-[#07306d]/70 leading-relaxed">
              Dedicated professionals empowering Opalin Healthcare System to drive excellence in medical billing and revenue cycle management.
            </p>
          </motion.div>
        </div>
      </section>
              ...
              >
                <div className="bg-white rounded-2xl border border-[#e5edf2] overflow-hidden hover:shadow-xl transition-all duration-300">
                  <div className="relative overflow-hidden aspect-square">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#07306d]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                      <div className="flex gap-3">
                        <a
                          href={`mailto:${member.email}`}
                          className="w-10 h-10 bg-white rounded-lg flex items-center justify-center hover:bg-[#2aa99b] transition-colors group"
                        >
                          <Mail className="w-5 h-5 text-[#07306d] group-hover:text-white" />
                        </a>
                        <a
                          href={member.linkedin}
                          className="w-10 h-10 bg-white rounded-lg flex items-center justify-center hover:bg-[#2aa99b] transition-colors group"
                        >
                          <Linkedin className="w-5 h-5 text-[#07306d] group-hover:text-white" />
                        </a>
                      </div>
                    </div>
                  </div>
